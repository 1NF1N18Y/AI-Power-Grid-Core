...
// static void _0032b_single(benchmark::Bench& bench)
// {
//     uint256 hash;
//     std::vector<uint8_t> in(32,0);
...
// static void _0080b_single(benchmark::Bench& bench)
// {
//     uint256 hash;
//     std::vector<uint8_t> in(80,0);
//     bench.minEpochIterations(10000).run([&] {
...
// static void _0128b_single(benchmark::Bench& bench)
// {
//     uint256 hash;
//     std::vector<uint8_t> in(128,0);
//     bench.minEpochIterations(10000).run([&] {
...
// static void _0512b_single(benchmark::Bench& bench)
// {
//     uint256 hash;
//     std::vector<uint8_t> in(512,0);
//     bench.minEpochIterations(10000).run([&] {
...
// static void _1024b_single(benchmark::Bench& bench)
// {
//     uint256 hash;
//     std::vector<uint8_t> in(1024,0);
//     bench.minEpochIterations(10000).run([&] {
...
// static void _2048b_single(benchmark::Bench& bench)
// {
//     uint256 hash;
//     std::vector<uint8_t> in(2048,0);
//     bench.minEpochIterations(10000).run([&] {
